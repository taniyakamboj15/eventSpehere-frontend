    ...
    return (
        <section className="container mx-auto px-4 py-16 border-t border-border">
             <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-text mb-2">Recent Memories</h2>
                <p className="text-textSecondary">See what our community has been up to.</p>
            </div>
                    ...
                    <div key={event._id} className="group relative aspect-square rounded-2xl overflow-hidden">
                        {event.photos?.[0] ? (
                            ...
                            <div className="w-full h-full bg-gray-100 flex items-center justify-center">
                                <span className="text-textSecondary text-xs font-bold uppercase">No Image</span>
                            </div>
                        )}
